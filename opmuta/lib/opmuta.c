...
char tipo[TAMLEX + 1], ptar[TAMLEX + 1], tipo1[TAMLEX + 1], ptar1[TAMLEX + 1];
...
int g_calling, g_called, g_unit, g_restrict;

char	*g_funcoes, *g_conexoes;

opmuta (DirLI, ArqLI, DirFonte, ArqFonte, Funcoes, Conexoes, Restrict, seed)
