...
void DirVarRepConst(char *pre, char *pos)
{
char	*q, *get_rand();
...
void IndVarRepConst(char *pre, char *pos, int ret)
{
char    *q, *get_rand();
int     i, j, n, max, seq, nseq;
int     u, k, t;
